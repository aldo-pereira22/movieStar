    ...
    <div id="main-container" class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-6 offset-md-1">
                    ...
                    <form id="edit-movie-form" action="<?=$BASE_URL ?>movie_process.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="<?= $movie->title ?>" placeholder="Digite o título do seu filme">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="trailer" value="<?= $movie->trailer ?>" name="trailer" placeholder="Insira o Link do Trailer">
                ...
                <div class="col-md-3">
                    <div class="image-container" style="background-image:url('<?= $BASE_URL ?>img/movies/<?=$movie->image ?>')"></div>
                </div>
        </div>
    </div>
